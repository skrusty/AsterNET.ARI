...
namespace AsterNET.ARI.Actions
{
	...
	public interface IChannelsActions
	{
		...
		Channel Originate(string endpoint, string extension = null, string context = null, long? priority = null, string app = null, string appArgs = null, string callerId = null, int? timeout = null, List<KeyValuePair<string, string>> variables = null, string channelId = null, string otherChannelId = null);
		/// <summary>
		/// Channel details.. 
		/// </summary>
		...
		/// <param name="variables">The "variables" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { "endpoint": "SIP/Alice", "variables": { "CALLERID(name)": "Alice" } }</param>
		/// <param name="otherChannelId">The unique id to assign the second channel when using local channels.</param>
		Channel OriginateWithId(string channelId, string endpoint, string extension = null, string context = null, long? priority = null, string app = null, string appArgs = null, string callerId = null, int? timeout = null, List<KeyValuePair<string, string>> variables = null, string otherChannelId = null);
		/// <summary>
