...
namespace AsterNET.ARI.Actions
{
	...
	public class ChannelsActions : ARIBaseAction
	{
		...
		public Channel Originate(string endpoint, string extension, string context, long priority, string app, string appArgs, string callerId, int timeout)
		{
			string path = "/channels";
		...
		public Playback Play(string channelId, string media, string lang, int offsetms, int skipms)
		{
		...
		/// <param name="appArgs">The application arguments to pass to the Stasis application</param>
		public Channel SnoopChannel(string channelId, string spy, string whisper, string app, string appArgs)
		{
