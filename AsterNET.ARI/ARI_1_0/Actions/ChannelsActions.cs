...
namespace AsterNET.ARI.Actions
{
	...
	public class ChannelsActions : ARIBaseAction, IChannelsActions
	{
		...
		public Channel Originate(string endpoint, string extension = null, string context = null, long? priority = null, string label = null, string app = null, string appArgs = null, string callerId = null, int? timeout = null, Dictionary<string, string> variables = null, string channelId = null, string otherChannelId = null, string originator = null, string formats = null)
		{
			...
			if(appArgs != null)
				request.AddParameter("appArgs", appArgs);
			if(callerId != null)
			...
			if(variables != null)
			{
				request.AddBody(new { variables = variables });
			}
			if(channelId != null)
				request.AddParameter("channelId", channelId);
			if(otherChannelId != null)
				request.AddParameter("otherChannelId", otherChannelId);
			if(originator != null)
				request.AddParameter("originator", originator);
			if(formats != null)
				request.AddParameter("formats", formats);
		...
		public void SendDTMF(string channelId, string dtmf = null, int? before = null, int? between = null, int? duration = null, int? after = null)
		{
			...
			if(channelId != null)
				request.AddUrlSegment("channelId", channelId);
			if(dtmf != null)
				request.AddParameter("dtmf", dtmf);
			if(before != null)
				request.AddParameter("before", before);
			if(between != null)
				request.AddParameter("between", between);
			if(duration != null)
		...
		public void StartMoh(string channelId, string mohClass = null)
		{
			...
			if(channelId != null)
				request.AddUrlSegment("channelId", channelId);
			if(mohClass != null)
				request.AddParameter("mohClass", mohClass);
			var response = Execute(request);
			if((int)response.StatusCode >= 200 && (int)response.StatusCode < 300)
				return;
			switch((int)response.StatusCode)
		...
		public Playback Play(string channelId, string media, string lang = null, int? offsetms = null, int? skipms = null, string playbackId = null)
		{
			...
			if(channelId != null)
				request.AddUrlSegment("channelId", channelId);
			if(media != null)
				request.AddParameter("media", media);
			if(lang != null)
				request.AddParameter("lang", lang);
			if(offsetms != null)
				request.AddParameter("offsetms", offsetms);
			if(skipms != null)
				request.AddParameter("skipms", skipms);
			if(playbackId != null)
				request.AddParameter("playbackId", playbackId);
		...
		public LiveRecording Record(string channelId, string name, string format, int? maxDurationSeconds = null, int? maxSilenceSeconds = null, string ifExists = null, bool? beep = null, string terminateOn = null)
		{
			...
			if(maxDurationSeconds != null)
				request.AddParameter("maxDurationSeconds", maxDurationSeconds);
			if(maxSilenceSeconds != null)
				request.AddParameter("maxSilenceSeconds", maxSilenceSeconds);
			if(ifExists != null)
				request.AddParameter("ifExists", ifExists);
			if(beep != null)
				request.AddParameter("beep", beep);
			if(terminateOn != null)
				request.AddParameter("terminateOn", terminateOn);
		...
		public Channel SnoopChannel(string channelId, string app, string spy = null, string whisper = null, string appArgs = null, string snoopId = null)
		{
			...
			if(channelId != null)
				request.AddUrlSegment("channelId", channelId);
			if(spy != null)
				request.AddParameter("spy", spy);
			if(whisper != null)
				request.AddParameter("whisper", whisper);
			if(app != null)
				request.AddParameter("app", app);
			if(appArgs != null)
				request.AddParameter("appArgs", appArgs);
			if(snoopId != null)
				request.AddParameter("snoopId", snoopId);
