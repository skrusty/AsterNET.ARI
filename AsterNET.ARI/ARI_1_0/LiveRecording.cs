...
namespace AsterNET.ARI.Models
{
	...
	public class LiveRecording
	{
		...
		/// <summary>
		///     Duration of talking, in seconds, detected in the recording. This is only available if the recording was initiated
		///     with a non-zero maxSilenceSeconds.
		/// </summary>
		public int Talking_duration { get; set; }

		/// <summary>
		///     Duration of silence, in seconds, detected in the recording. This is only available if the recording was initiated
		///     with a non-zero maxSilenceSeconds.
		/// </summary>
