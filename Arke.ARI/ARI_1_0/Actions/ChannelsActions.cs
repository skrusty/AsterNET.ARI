...
namespace Arke.ARI.Actions
{
    ...
    public class ChannelsActions : ARIBaseAction, IChannelsActions
    {
        ...
        /// </summary>
        public virtual List<Channel> List()
        {
        ...
        /// <param name="formats">The format name capability list to use if originator is not specified. Ex. "ulaw,slin16".  Format names can be found with "core show codecs".</param>
        /// <param name="variables">The "variables" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { "endpoint": "SIP/Alice", "variables": { "CALLERID(name)": "Alice" } }</param>
        public virtual Channel Create(string endpoint, string app, string appArgs = null, string channelId = null, string otherChannelId = null, string originator = null, string formats = null, Dictionary<string, string> variables = null)
        {
        ...
        public virtual Channel Get(string channelId)
        {
        ...
        public virtual void Hangup(string channelId, string reason_code = null, string reason = null)
        {
            string path = "channels/{channelId}";
        ...
        public virtual void ContinueInDialplan(string channelId, string context = null, string extension = null, int? priority = null, string label = null)
        {
        ...
        public virtual void Move(string channelId, string app, string appArgs = null)
        {
        ...
        public virtual void Redirect(string channelId, string endpoint)
        {
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual void Answer(string channelId)
        {
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual void Ring(string channelId)
        {
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual void RingStop(string channelId)
        {
            string path = "channels/{channelId}/ring";
            var request = GetNewRequest(path, HttpMethod.DELETE);
            if (channelId != null)
        ...
        public virtual void SendDTMF(string channelId, string dtmf = null, int? before = null, int? between = null, int? duration = null, int? after = null)
        {
        ...
        public virtual void Mute(string channelId, string direction = null)
        {
        ...
        public virtual void Unmute(string channelId, string direction = null)
        {
            string path = "channels/{channelId}/mute";
            var request = GetNewRequest(path, HttpMethod.DELETE);
            if (channelId != null)
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual void Hold(string channelId)
        {
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual void Unhold(string channelId)
        {
            string path = "channels/{channelId}/hold";
            var request = GetNewRequest(path, HttpMethod.DELETE);
            if (channelId != null)
        ...
        public virtual void StartMoh(string channelId, string mohClass = null)
        {
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual void StopMoh(string channelId)
        {
            string path = "channels/{channelId}/moh";
            var request = GetNewRequest(path, HttpMethod.DELETE);
            if (channelId != null)
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual void StartSilence(string channelId)
        {
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual void StopSilence(string channelId)
        {
            string path = "channels/{channelId}/silence";
            var request = GetNewRequest(path, HttpMethod.DELETE);
            if (channelId != null)
        ...
        public virtual Playback Play(string channelId, string media, string lang = null, int? offsetms = null, int? skipms = null, string playbackId = null)
        {
        ...
        /// <param name="offsetms">Number of milliseconds to skip before playing. Only applies to the first URI if multiple media URIs are specified.</param>
        /// <param name="skipms">Number of milliseconds to skip for forward/reverse operations.</param>
        public virtual Playback PlayWithId(string channelId, string playbackId, string media, string lang = null, int? offsetms = null, int? skipms = null)
        {
        ...
        public virtual LiveRecording Record(string channelId, string name, string format, int? maxDurationSeconds = null, int? maxSilenceSeconds = null, string ifExists = null, bool? beep = null, string terminateOn = null)
        {
        ...
        public virtual Variable GetChannelVar(string channelId, string variable)
        {
        ...
        public virtual void SetChannelVar(string channelId, string variable, string value = null)
        {
            string path = "channels/{channelId}/variable";
            var request = GetNewRequest(path, HttpMethod.POST);
            if (channelId != null)
        ...
        public virtual Channel SnoopChannel(string channelId, string app, string spy = null, string whisper = null, string appArgs = null, string snoopId = null)
        {
        ...
        /// <param name="app">Application the snooping channel is placed into</param>
        /// <param name="appArgs">The application arguments to pass to the Stasis application</param>
        public virtual Channel SnoopChannelWithId(string channelId, string snoopId, string app, string spy = null, string whisper = null, string appArgs = null)
        {
        ...
        public virtual void Dial(string channelId, string caller = null, int? timeout = null)
        {
        ...
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        public virtual RTPstat Rtpstatistics(string channelId)
        {
        ...
        public virtual Channel ExternalMedia(string app, string external_host, string format, string channelId = null, Dictionary<string, string> variables = null, string encapsulation = null, string transport = null, string connection_type = null, string direction = null, string data = null)
        {
